...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('warehouse.trucks.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('license_plate') is-invalid @enderror" 
                           id="license_plate" name="license_plate" value="{{ old('license_plate') }}" required min="0">
                    @error('license_plate')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('container_volume') is-invalid @enderror" 
                           id="container_volume" name="container_volume" value="{{ old('container_volume') }}" required min="0">
